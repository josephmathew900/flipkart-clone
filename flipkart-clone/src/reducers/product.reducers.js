...
const productReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case productConstants.GET_PRODUCT_PAGE_FAILURE:
      ...
      break;
    case productConstants.GET_PRODUCT_DETAILS_PAGE_BY_ID_REQUEST:
      state = { ...state, loading: true };
      break;
    case productConstants.GET_PRODUCT_DETAILS_PAGE_BY_ID_SUCCESS:
      state = {
        ...state,
        loading: false,
      ...
      break;
    case productConstants.GET_PRODUCT_DETAILS_PAGE_BY_ID_FAILURE:
